...
export const incidentKeys = [
  ...
  { category: "3", value: "3-1", label: "3-1 Auxilio a Carros" },
  { category: "3", value: "3-2", label: "3-2 Auxilio a Otros" },
  { category: "3", value: "3-3", label: "3-3 Auxilio Policial" },
  { category: "3", value: "3-4", label: "3-4 Auxilio Municipal" },
  { category: "4", value: "4-1", label: "4-1 Materiales Corrosivos" },
  { category: "4", value: "4-2", label: "4-2 Gases" },
  { category: "4", value: "4-3", label: "4-3 Explosivos" },
  { category: "4", value: "4-4", label: "4-4 Materiales Comburentes" },
  { category: "4", value: "4-5", label: "4-5 Líquidos Inflamables" },
  { category: "4", value: "4-6", label: "4-6 Sólidos Inflamables" },
  { category: "4", value: "4-7", label: "4-7 Materiales Tóxicos" },
  { category: "4", value: "4-8", label: "4-8 Materiales Radiactivos" },
